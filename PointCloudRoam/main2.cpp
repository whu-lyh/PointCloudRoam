...
// @date 2019年12月11日17:41:57
// @brief 用于车载点云一致性改正前后点云漫游
...
int main ()
{
	//std::string las1_path = "C:/Users/zxh/Desktop/demo_data/traj2/pc1";
	//std::string las2_path = "F:/DEMO-curb/original-pointcloud";
